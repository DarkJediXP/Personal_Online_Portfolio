...
<html lang="en">
 ...
 <link href="styles/main.css" rel="stylesheet">
	...
	<body>
		<div id = "page">
			<div class = "topcorner">
     <form class="logout-button" role="form" action="csharpGameToHome" method="post" >
    <button class="btn btn-lg btn-primary " type="submit">Return to Homepage</button>
			...
			<div id = "content">
				...
				<h1>Introducing 2D Asteroid</h1>
				<img src="images/csharpGame.jpg" alt="" class="img-rounded">
				</div>
				</a>
			</div>
			...
			<img src="images/asttn1.jpg" alt="" class="img-thumbnail">
			<img src="images/asttn2.gif" alt="" class="img-thumbnail">
			</div>
			<?php
	 			 		$mysqli = new mysqli(DB_HOST, DB_USERNAME, DB_PASSWORD, DB_NAME);
	 			 		$result = $mysqli->query("select cast(avg(rating) as decimal(3,2)) from user_project_reviews where project_id = 3");
			...
			<form class="textarea" role="form" action="review-csharpgame-comment" method="post" >
...
<!-- <button class="btn  btn-primary" type="submit">Rate!</button>
			...
			<!--	 <form class="textarea" role="form" action="review-csharpgame-comment" method="post" > -->
				 	<h3> Comment </h3> 
				   <textarea name= "csharpgame-comment" class="form-control" rows="4" cols="50" placeholder="Leave a review - users reviews are anonymous..."></textarea>
				   <br>
 ...
 <br>
 			...
 			<table class="table">
 			 	...
 			 	<tr>
	 			 	...
	 			 	<?php
	 			 		$mysqli = new mysqli(DB_HOST, DB_USERNAME, DB_PASSWORD, DB_NAME);
	 			 		$result = $mysqli->query("select review_text from user_project_reviews where project_id = 3");
		 			 	while ($row = $result->fetch_assoc()) {
